...
"}")
        ...
        try:
            ...
            for i in kompetencia_list:
                ...
                chetbox = browser.find_element(By.XPATH,
                                               "/html/body/div[1]/div[2]/div/div/div/div[3]/form/table/tbody/tr[2]/td[3]/select")
                chetbox.click()
    ...
    def add_recocomendacii_auto(self):
        ...
        try:
            ...
            # авторизація
            url_2 = "https://ircenter.gov.ua/irc/index/ko-forms-detail/form_id/41068"
            browser.get(url_2)
            time.sleep(2)
